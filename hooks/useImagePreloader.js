...
const menuItems = [
  ...
  require('../assets/images/old/old_menu.png'),
...
const DECK_CARD_IMAGES = {
  ...
  old: [
    require('../assets/images/old/old_00.png'),
    require('../assets/images/old/old_01.png'),
    require('../assets/images/old/old_02.png'),
    require('../assets/images/old/old_03.png'),
    require('../assets/images/old/old_04.png'),
    require('../assets/images/old/old_05.png'),
    require('../assets/images/old/old_06.png'),
    require('../assets/images/old/old_07.png'),
    require('../assets/images/old/old_08.png'),
    require('../assets/images/old/old_09.png'),
    require('../assets/images/old/old_10.png'),
    require('../assets/images/old/old_11.png'),
    require('../assets/images/old/old_12.png'),
    require('../assets/images/old/old_13.png'),
    require('../assets/images/old/old_14.png'),
    require('../assets/images/old/old_15.png'),
    require('../assets/images/old/old_16.png'),
    require('../assets/images/old/old_17.png'),
    require('../assets/images/old/old_18.png'),
    require('../assets/images/old/old_19.png'),
    require('../assets/images/old/old_20.png'),
    require('../assets/images/old/old_21.png'),
    require('../assets/images/old/old_22.png'),
    require('../assets/images/old/old_23.png'),
    require('../assets/images/old/old_24.png'),
    require('../assets/images/old/old_25.png'),
    require('../assets/images/old/old_26.png'),
    require('../assets/images/old/old_27.png'),
    require('../assets/images/old/old_28.png'),
    require('../assets/images/old/old_29.png'),
    require('../assets/images/old/old_30.png'),
    require('../assets/images/old/old_31.png'),
    require('../assets/images/old/old_32.png'),
    require('../assets/images/old/old_33.png'),
    require('../assets/images/old/old_34.png'),
    require('../assets/images/old/old_35.png'),
    require('../assets/images/old/old_36.png'),
    require('../assets/images/old/old_37.png'),
    require('../assets/images/old/old_38.png'),
    require('../assets/images/old/old_39.png'),
  ]
};
